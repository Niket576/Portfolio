...
const projects = [
...

  {
    ...
    para: `A recipe platform built with the PERN stack and Expo. It features secure Clerk 
    authentication, real-time search, and personalized recipe filtering. With embedded YouTube tutorials 
    and a persistent favorites system, it delivers an engaging, interactive, and user-friendly cooking 
