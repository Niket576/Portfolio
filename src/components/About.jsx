    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-20">
        <div className="md:w-30% md:ml-35 md:mt-20 mt-5 order-1">
          <img src={pic} className="rounded-lg md:ml-35 " alt="" />
        </div>
        <div className="md:w-70% mt-12 md:mt-20 md:mr-20 space-y-2 order-2 md:order-1">
          <p className="text-justify">
            I am a software engineer with a strong foundation in programming,
            focused on solving real world prblems and building efficient,
            scalable soulutions. My passion for the technology is reflected in
            the curiosity, dedication, and effort I bring to every project I
            worked on.
          </p>
          <p>
            I thrive in collaborative enviroments, where I can share ideas,
            learn from others, and take on challenges that help me grow. Beyond
            tech, I enjoy playing football to stay active and exploring new
            places, embracing fresh experiences and perspective.
          </p>
